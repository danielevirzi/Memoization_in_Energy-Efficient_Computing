...
class RunnerConfig:
    ...
    name:                       str             = "reverse_experiment"
    """target function location in remote laptop"""
    target_function_location = 'recursive.reverse'
    target_function_names = ['reverse_string', 'reverse_string_cache', 'reverse_string_lru_cache']
    input_size_options = ["abcde" * 10,"abcde" * 20,"abcde" * 30]
    input_description = ["abcde * 10","abcde * 20","abcde * 30"]
